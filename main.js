...
function addressToOffset(sections, address) {
...
function optionalVirtualPointer(type, target) {
...
function virtualPointer(type, target) {
    return pointer(type, target, 1, function (root) {
        return addressToOffset(root["Dos Header"]["New Header Offset"].target["Sections"], Number(this.value));
    });
}
function init() {
